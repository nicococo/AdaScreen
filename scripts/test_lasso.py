...
def main_method():
    ...
    parser.add_argument("-e","--experiment", help="experiment [0-5] (default 1)", default=3, type=int)
    ...
    parser.add_argument("-t","--toy_exms", help="Number of toy examples (default 100)", default=400, type=int)
